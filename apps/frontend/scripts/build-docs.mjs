...
const REGISTRY = [
  ...
  { file: 'manuals/05-daftar-notifikasi.md', slug: 'daftar-notifikasi', category: 'manual', audience: 'Tenant Owner / Manager', blurb: 'Referensi 26 pesan otomatis: pemicu, variabel, teks bawaan, dan contoh hasilnya.' },
