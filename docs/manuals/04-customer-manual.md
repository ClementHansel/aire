...
![The price eMenu — services and prices grouped by car wash and detailing.](images/cust-01-menu.png)
...
![The kiosk welcome screen — identify yourself, or continue as a guest.](images/cust-02-kiosk-order.png)
...
- **Queue status lookup** — open the queue-check link (`/kiosk/...`), enter your **order number**,
  ...
  ![Queue status lookup — enter your order number to see your position.](images/cust-03-queue-lookup.png)

- **Queue board** — the in-store TV screen shows the live queue for everyone in the waiting area.

  ![The in-store queue board (TV display).](images/cust-05-queue-board.png)
...
![The member portal sign-in — enter your WhatsApp number to get a code.](images/cust-04-portal-login.png)
