...
CANON = {
    ...
    "capacitance": ("F", {"pF": 1e-12, "nF": 1e-9, "uF": 1e-6, "mF": 1e-3, "F": 1}),
    ...
    "hardness_hrb": ("HRB", {"HRB": 1}),
    "hardness_hv": ("HV", {"HV10": 1, "HV": 1}),
    "hardness_hbw": ("HBW", {"HBW": 1}),
    "hardness_shore_oo": ("HOO", {"HOO": 1}),
    "gloss": ("Gloss", {"Gloss": 1}),
    "durometer": ("skala", {"skala": 1}),
    "turbidity": ("NTU", {"NTU": 1}),
    # For dilute aqueous samples 1 ppm is 1 mg/L, which is how these
    # certificates use it (COD, chlorine, dissolved oxygen).
    "concentration": ("mg/L", {"mg/L": 1, "ppm": 1, "ug/mL": 1}),
    ...
    "speed": ("m/s", {"m/s": 1, "km/h": 1.0 / 3.6, "ft/sec": 0.3048,
    ...
    "refractive_index": ("nD20", {"nD20": 1, "nD25": 1}),
    "brix": ("%Brix", {"%Brix": 1}),
    "colour_temp": ("K", {"K": 1}),
